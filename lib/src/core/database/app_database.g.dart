...
class UserTableData extends DataClass implements Insertable<UserTableData> {
  ...
  UserTableCompanion toCompanion(bool nullToAbsent) {
    return UserTableCompanion(
      ...
      passwordHint:
          passwordHint == null && nullToAbsent
              ? const Value.absent()
              : Value(passwordHint),
...
class PasswordTableData extends DataClass
  ...
  PasswordTableData copyWithCompanion(PasswordTableCompanion data) {
    return PasswordTableData(
      ...
      hasArchived:
          data.hasArchived.present ? data.hasArchived.value : this.hasArchived,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
    );
  }
...
class WalletTableData extends DataClass implements Insertable<WalletTableData> {
  ...
  WalletTableData copyWithCompanion(WalletTableCompanion data) {
    return WalletTableData(
      ...
      title: data.title.present ? data.title.value : this.title,
      seedPhrase:
          data.seedPhrase.present ? data.seedPhrase.value : this.seedPhrase,
      hasArchived:
          data.hasArchived.present ? data.hasArchived.value : this.hasArchived,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
                ...
                if (passwordId) {
                  state =
                      state.withJoin(
                            currentTable: table,
                            currentColumn: table.passwordId,
                            referencedTable: $$PasswordFieldTableTableReferences
                                ._passwordIdTable(db),
                            referencedColumn:
                                $$PasswordFieldTableTableReferences
                                    ._passwordIdTable(db)
                ...
                if (walletId) {
                  state =
                      state.withJoin(
                            ...
                            referencedTable: $$WalletFieldTableTableReferences
                                ._walletIdTable(db),
                            referencedColumn:
                                $$WalletFieldTableTableReferences
                                    ._walletIdTable(db)
