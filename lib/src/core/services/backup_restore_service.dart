...
class BackupRestoreService {
  static Future<bool> backup({
    ...
    final SharedPreferencesService sharedPreferencesService =
        SharedPreferencesService(sharedPreferences, resourcesDir);
    ...
    try {
      sharedValues = await sharedPreferencesService.exportData(
        databaseEncryptorService,
      );
  ...
  static Future<bool> restore(
    String backupPath,
    String password, {
    required AppDatabaseWrapper appDatabase,
    required Directory resourcesDir,
    required SharedPreferences sharedPreferences,
  }) async {
    bool success = true;
