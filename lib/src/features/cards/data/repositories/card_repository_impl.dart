...
class CardRepositoryImpl implements CardRepository {
  ...
  @override
  FailureOr<CardEntity> getCardById(int paramsId) async {
    try {
      final responce = await datasource.getCard(paramsId);
  ...
  @override
  FailureOr<List<CardEntity>> searchCards(SearchCardParams params) async {
    try {
      final responce = await datasource.searchCards(params);
      return Right(responce);
    } on Failure catch (e) {
      return Left(e);
    } catch (e) {
