...
class WalletRepositoryImpl implements WalletRepository {
  ...
  @override
  FailureOr<Wallet> getWallet(String id) async {
    try {
      final responce = await datasource.getWallet(id);
  ...
  @override
  FailureOr<List<Wallet>> searchWallet(SearchWalletParams params) async {
    try {
      final responce = await datasource.searchWallet(params);
      return Right(responce.map((e) => e.toEntity()).toList());
    } catch (e) {
      return Left(UnknownFailure());
    }
